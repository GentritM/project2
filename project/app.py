...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/master/Desktop/project2/project/engage.db'
...
class TweetForm(FlaskForm):
    ...
    image = FileField(validators=[FileAllowed(IMAGES, 'Images accepted')])
...
def post_tweet():
    ...
    if form.validate():
        ...
        tweet = Tweet(user_id=current_user.id, text=form.text.data, image=image_url, date_created=datetime.now())
